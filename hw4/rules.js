...
function begin_play(){
	...
	if(isEmpty(p1) || isEmpty(p2)){
		...
		if(!started){
			...
			this.started = true;
			document.getElementById("turn_info").innerHTML = "Player " + whose_move() + "'s turn";
		}
		else{
         ...
         if(!this.table_ids.includes(move)){
			...
			if(this.board_state[this.table_ids.indexOf(move)] == -1){
				if(whose_move()){
					...
					document.getElementById("turn_info").innerHTML = "Player " + 2 + "'s turn";
					toggle_move();
				}
				else{
					document.getElementById(move).innerHTML = "O";
					this.board_state[this.table_ids.indexOf(move)] = 0;
					document.getElementById("turn_info").innerHTML = "Player " + 1 + "'s turn";
					toggle_move();
				}
				checkWinner();
			}
...
//sorry about these if statements i didnt feel like splitting it up
function checkWinner(){
	if((this.board_state[0] == 1 && this.board_state[1] == 1 && this.board_state[2] == 1) ||
	(this.board_state[0] == 1 && this.board_state[3] == 1 && this.board_state[6] == 1) ||
	(this.board_state[1] == 1 && this.board_state[4] == 1 && this.board_state[7] == 1) ||
	(this.board_state[2] == 1 && this.board_state[5] == 1 && this.board_state[8] == 1) ||
	(this.board_state[3] == 1 && this.board_state[4] == 1 && this.board_state[5] == 1) ||
	(this.board_state[6] == 1 && this.board_state[7] == 1 && this.board_state[8] == 1) ||
	(this.board_state[2] == 1 && this.board_state[4] == 1 && this.board_state[6] == 1)){
		alert("Player " + 1 + " won the game");
		reset_play();
	}

	if((this.board_state[0] == 0 && this.board_state[1] == 0 && this.board_state[2] == 0) ||
	(this.board_state[0] == 0 && this.board_state[3] == 0 && this.board_state[6] == 0) ||
	(this.board_state[1] == 0 && this.board_state[4] == 0 && this.board_state[7] == 0) ||
	(this.board_state[2] == 0 && this.board_state[5] == 0 && this.board_state[8] == 0) ||
	(this.board_state[3] == 0 && this.board_state[4] == 0 && this.board_state[5] == 0) ||
	(this.board_state[6] == 0 && this.board_state[7] == 0 && this.board_state[8] == 0) ||
	(this.board_state[2] == 0 && this.board_state[4] == 0 && this.board_state[6] == 0)){
