...
function openModal() {
    ...
    confirmMyInput.onkeyup = function() {
                ...
                passEqualsConfPass = (true); // TODO: Change this to the condition that needs to be checked so that the text entered in password equals the text in confirm password
...
function enableButton(letter, capital, number, length, match) {
    ...
    var condition = lowerMatch && upperMatch && numMatch && lengthMatch && passEqualsConfPass; // TODO: Replace false with the correct condition
    if(condition) {
